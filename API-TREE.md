...
└─|─ /snapshots/
  ...
  |  └── mock-data                            • RECONCILED: POST /snapshots/mock-data (demo seed; 1513 pairs / bootstrap 14 absolute through Phase Final; SeededCredentials re-pointed off identity rows at Final Task 1(d))
