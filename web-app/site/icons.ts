...
function icon(paths: string, size = 16, cssClass = ''): SafeHtml {
  return new SafeHtml(`<svg xmlns="http://www.w3.org/2000/svg" width="${size}" height="${size}" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="${cssClass}">${paths}</svg>`);
}
