...
function buildBaselineComparison(project: ProjectDetail): SafeHtml {
  return html`
    <div class="card p-6">
...
function buildEdgeKPIs(project: ProjectDetail): SafeHtml {
  return html`
    <div class="card p-6">
...
function buildProjectTabs(project: ProjectDetail): SafeHtml {
  return html`
    <div class="card p-6">
...
function buildProjectSidebar(project: ProjectDetail): SafeHtml {
  return html`
