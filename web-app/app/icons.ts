...
function iconBell(size = 16, cssClass = '') {
    return icon(
        ...
        + ' 9 3 9H3s3-2 3-9"/>'
        + '<path d="M10.3 21a1.94 1.94 0 0 0'
        + ' 3.4 0"/>',
        size,
        cssClass,
    );
...
function iconSettings(
    ...
    return icon(
        ...
        + ' 2v.18a2 2 0 0 1-1 1.73l-.43.25a2'
        + ' 2 0 0 1-2 0l-.15-.08a2 2 0 0'
        + ' 0-2.73.73l-.22.38a2 2 0 0 0 .73'
        + ' 2.73l.15.1a2 2 0 0 1 1 1.72v.51a2'
        + ' 2 0 0 1-1 1.74l-.15.09a2 2 0 0'
        + ' 0-.73 2.73l.22.38a2 2 0 0 0 2.73'
        + ' .73l.15-.08a2 2 0 0 1 2 0l.43.25a'
        + '2 2 0 0 1 1 1.73V20a2 2 0 0 0 2'
        + ' 2h.44a2 2 0 0 0 2-2v-.18a2 2 0 0'
        + ' 1 1-1.73l.43-.25a2 2 0 0 1 2'
        + ' 0l.15.08a2 2 0 0 0 2.73-.73l.22'
        + '-.39a2 2 0 0 0-.73-2.73l-.15-.08a2'
        + ' 2 0 0 1-1-1.74v-.5a2 2 0 0 1'
        + ' 1-1.74l.15-.09a2 2 0 0 0'
        + ' .73-2.73l-.22-.38a2 2 0 0'
        + ' 0-2.73-.73l-.15.08a2 2 0 0 1-2'
        + ' 0l-.43-.25a2 2 0 0 1-1-1.73V4a2 2'
        + ' 0 0 0-2-2z"/>'
...
function iconAward(size = 16, cssClass = '') {
    return icon(
        ...
        + '-2.687a1 1 0 0 0-1.197 0l-3.586'
        + ' 2.686a.5.5 0 0 1-.81-.469l1.514'
        + '-8.526"/>'
...
function iconWand(size = 16, cssClass = '') {
    return icon(
        ...
        + ' 1.21 0 0 0 0 1.72l1.28 1.28a1.2'
        + ' 1.2 0 0 0 1.72 0L21.64 5.36a1.2'
        + ' 1.2 0 0 0 0-1.72Z"/>'
        + '<path d="m14 7 3 3"/>'
        + '<path d="M5 6v4"/>'
        + '<path d="M19 14v4"/>'
...
function iconActivity(
    ...
    return icon(
        ...
        + ' 0-1.93 1.46l-2.35 8.36a.25.25 0 0'
        + ' 1-.48 0L9.24 2.18a.25.25 0 0'
        + ' 0-.48 0l-2.35 8.36A2 2 0 0 1 4.49'
        + ' 12H2"/>',
        size,
        cssClass,
    );
...
function iconCrown(size = 16, cssClass = '') {
    return icon(
        ...
        + ' .294L21.183 5.5a.5.5 0 0 1'
        + ' .798.519l-2.834 10.246a1 1 0 0'
        + ' 1-.956.734H5.81a1 1 0 0'
        + ' 1-.957-.734L2.02 6.02a.5.5 0 0 1'
        + ' .798-.519l4.276 3.664a1 1 0 0 0'
        + ' 1.516-.294z"/>'
        + '<path d="M5 21h14"/>',
        size,
        cssClass,
...
function iconFolderOpen(
    ...
    return icon(
        ...
        + ' 9.24 10H20a2 2 0 0 1 1.94'
        + ' 2.5l-1.54 6a2 2 0 0 1-1.95'
        + ' 1.5H4a2 2 0 0 1-2-2V5a2 2 0 0 1'
        + ' 2-2h3.9a2 2 0 0 1 1.69.9l.81'
        + ' 1.2a2 2 0 0 0 1.67.9H18a2 2 0 0'
        + ' 1 2 2v2"/>',
        size,
        cssClass,
    );
...
function iconListTodo(
    ...
    return icon(
        ...
        + '<line x1="13" x2="21" y1="6"'
        + ' y2="6"/>'
        + '<line x1="13" x2="21" y1="12"'
        + ' y2="12"/>'
        + '<line x1="13" x2="21" y1="18"'
        + ' y2="18"/>',
        size,
        cssClass,
    );
...
function iconType(size = 16, cssClass = '') {
    return icon(
        ...
        + ' 20 7"/>'
        + '<line x1="9" x2="15" y1="20"'
        + ' y2="20"/>'
        + '<line x1="12" x2="12" y1="4"'
        + ' y2="20"/>',
        size,
        cssClass,
    );
...
function iconSlider(size = 16, cssClass = '') {
    return icon(
        ...
        + ' y2="14"/>'
        + '<line x1="4" x2="4" y1="10"'
        + ' y2="3"/>'
        + '<line x1="12" x2="12" y1="21"'
        + ' y2="12"/>'
        + '<line x1="12" x2="12" y1="8"'
        + ' y2="3"/>'
        + '<line x1="20" x2="20" y1="21"'
        + ' y2="16"/>'
        + '<line x1="20" x2="20" y1="12"'
        + ' y2="3"/>'
        + '<line x1="2" x2="6" y1="14"'
        + ' y2="14"/>'
        + '<line x1="10" x2="14" y1="8"'
        + ' y2="8"/>'
        + '<line x1="18" x2="22" y1="16"'
        + ' y2="16"/>',
        size,
        cssClass,
    );
