...
const pageModules: Record<string, () => Promise<{ init: (params?: Record<string, string>) => void | Promise<void> }>> = {
  ...
  'idea-detail': () => import('../ideas/detail/index'),
  ...
  'idea-create': () => import('../ideas/create/index'),
  'idea-convert': () => import('../ideas/convert/index'),
  'idea-review-queue': () => import('../ideas/review-queue/index'),
