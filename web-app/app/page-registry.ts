...
export const PAGE_REGISTRY: Record<string, PageEntry> = {
  ...
  'flow-detail':              { title: 'Flow Detail',              layout: 'sidebar',    sourceDir: 'flow', sourceFile: 'detail' },
  teams:                      { title: 'Teams',                    layout: 'sidebar' },
  account:                    { title: 'Administration',            layout: 'sidebar',    sourceDir: 'administration' },
  profile:                    { title: 'Profile',                  layout: 'sidebar' },
  settings:                   { title: 'Company Settings',         layout: 'sidebar' },
  'manage-users':             { title: 'Manage Users',             layout: 'sidebar',    sourceDir: 'administration', sourceFile: 'manage-users' },
  'activity-feed':            { title: 'Activity Feed',            layout: 'sidebar',    sourceDir: 'teams', sourceFile: 'activity-feed' },
