    ...
    <div style=${'min-height:100vh;'
      ...
      <div
        ...
        <div class="dialog-footer">
          <button
            class="btn btn-outline"
            id="approval-reject-cancel">
            Cancel
          </button>
          <button
            class="btn btn-error"
            id="approval-reject-confirm">
            Send Back
          </button>
        </div>
      </div>
      ...
      <div
        id="approval-clarify-backdrop"
        class="dialog-backdrop hidden">
      </div>
      <div
        id="approval-clarify-dialog"
        class="dialog hidden"
        role="dialog"
        aria-modal="true"
        style="max-width:28rem">
