...
Innovation workflow pages — from idea submission through project execution.
...
| [projects](projects/) | composed | Browse projects with progress bars and metrics |
| [project-detail](project-detail/) | composed | Tabbed project hub (tasks, discussion, history, data) |
| [engineering-requirements](engineering-requirements/) | composed | Technical spec with Q&A thread |
