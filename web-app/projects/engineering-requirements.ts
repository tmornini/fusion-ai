  ...
  setHtml(root, html`
    <div style="max-width:56rem;
      ...
      <div class="flex items-center gap-2
        ...
        <a href="../projects/detail.html?projectId=${projectId}"
            class="hover-link">
          ${project.title}
        </a><span>/</span>
        <span>
      ...
      <div class="card p-6 mb-6">
        ...
        <div style="display:flex;
          ...
          <div>
            ...
            <p class="text-muted">
              ${project.businessContext.expectedOutcome}
            </p>
          </div>
        </div>
      </div>
        ...
        <div class="convert-grid"
          ...
          ${project.team.map(
            ...
            <div
              ...
              <span class="badge ${teamMember.type
                  === 'business'
                ? 'badge-primary'
                : 'badge-success'} text-xs">
                ${teamMember.type}
      ...
      <div class="card p-6 mb-8">
        <h3 class="flex items-center gap-2
            text-lg font-display
            font-semibold mb-4">
          ${iconFileText(20, 'text-primary')}
          Source Idea
        </h3>
        <a href="../idea-convert/index.html?ideaId=${project.linkedIdea.id}"
        ...
        <div class="card"
          ...
          <div style="display:flex;
            ...
            <button
                ...
                id="requirements-send"
                disabled>
              ${iconSend(16)} Send Question
            </button>
          </div>
        </div>
        <div style="display:flex;
