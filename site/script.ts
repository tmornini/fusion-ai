...
const pageModules: Record<string, () => Promise<{ init: (params?: Record<string, string>) => void | Promise<void> }>> = {
  ...
  ideas: () => import('../ideas/page'),
  projects: () => import('../projects/page'),
  team: () => import('../team/page'),
  edge: () => import('../edge/page'),
  'edge-list': () => import('../edge-list/page'),
  'project-detail': () => import('../project-detail/page'),
  account: () => import('../account/page'),
  profile: () => import('../profile/page'),
  'company-settings': () => import('../company-settings/page'),
  'manage-users': () => import('../manage-users/page'),
  'activity-feed': () => import('../activity-feed/page'),
  'notification-settings': () => import('../notification-settings/page'),
  'engineering-requirements': () => import('../engineering-requirements/page'),
  crunch: () => import('../crunch/page'),
  flow: () => import('../flow/page'),
  'design-system': () => import('../design-system/page'),
  'idea-review-queue': () => import('../idea-review-queue/page'),
