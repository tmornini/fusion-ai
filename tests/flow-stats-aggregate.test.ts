        ...
        const input: FlowStatsInput = { ...f,
            transitions: [
                { id: 't0', workOrderId: 'w1',
                  kind: 'creation',
                  toNodeId: 'c', memberId: 'p1',
                  at: tCreated },
                { id: 't1', workOrderId: 'w1',
                  kind: 'step',
                  fromNodeId: 'c',
                  toNodeId: 'a', memberId: 'p1',
                  at: tCreated },
                { id: 't2', workOrderId: 'w1',
                  kind: 'step',
                  fromNodeId: 'a',
                  toNodeId: 'b', memberId: 'p2',
                  at: tEnterB },
                { id: 't3', workOrderId: 'w1',
                  kind: 'step',
                  fromNodeId: 'b',
                  toNodeId: 'z', memberId: 'p1',
                  at: tEnterZ },
            ],
        };
        ...
        const input: FlowStatsInput = { ...f,
            transitions: [
                { id: '1a', workOrderId: 'w1',
                  ...
                  toNodeId: 'c', memberId: 'p1',
                  at: t(3 * H) },
                { id: '1b', workOrderId: 'w1',
                  kind: 'step',
                  fromNodeId: 'c',
                  toNodeId: 'a', memberId: 'p1',
                  at: t(3 * H) },
                { id: '1c', workOrderId: 'w1',
                  kind: 'step',
                  fromNodeId: 'a',
                  toNodeId: 'b', memberId: 'p1',
                  at: t(1 * H) },
                { id: '1d', workOrderId: 'w1',
                  kind: 'step',
                  fromNodeId: 'b',
                  toNodeId: 'z', memberId: 'p1',
                  at: t(0) },
                { id: '2a', workOrderId: 'w2',
                  kind: 'creation',
                  toNodeId: 'c', memberId: 'p2',
                  at: t(6 * H) },
                { id: '2b', workOrderId: 'w2',
                  kind: 'step',
                  fromNodeId: 'c',
                  toNodeId: 'a', memberId: 'p2',
                  at: t(6 * H) },
                ...
                { id: '2f', workOrderId: 'w2',
                  kind: 'step',
                  fromNodeId: 'b',
                  toNodeId: 'z', memberId: 'p2',
                  at: t(0) },
                { id: '3a', workOrderId: 'w3',
                  kind: 'creation',
                  toNodeId: 'c', memberId: 'p3',
                  at: t(1 * H) },
                { id: '3b', workOrderId: 'w3',
                  kind: 'step',
                  fromNodeId: 'c',
                  toNodeId: 'a', memberId: 'p3',
                  at: t(1 * H) },
            ],
        };
        const m = buildFlowStats(input);
...
test(
    ...
    () => {
        ...
        const outs = [
            { id:'o1', workOrderId:'w0',
              kind: 'step',
              fromNodeId:'b',
              toNodeId:'z', memberId:'p1',
              at:t(0) },
            { id:'o2', workOrderId:'w1',
              kind: 'step',
              fromNodeId:'b',
              toNodeId:'z', memberId:'p1',
              at:t(1*H) },
