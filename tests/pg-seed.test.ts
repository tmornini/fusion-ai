...
describe('pg seed', () => {
    it('parseSeedArgv accepts one mode flag', () => {
        assertEquals(
    ...
    it('parseSeedArgv help is kind help', () => {
        assertEquals(
            parseSeedArgv(['--help']),
            { kind: 'help' },
        );
    ...
    it('parseSeedArgv none two unknown', () => {
    ...
    it('seedErrorMessage never echoes a URL', () => {
        assertStrictEquals(
    ...
    it('isDatabaseEmpty is true when no rows exist',
    async () => {
    ...
    it('assertEmptyDatabase refuses any message row',
    async () => {
    ...
    it('assertEmptyDatabase refuses a marker row',
    async () => {
    ...
    it('postgres-seed refuses leftover pairs before DDL',
    () => {
    ...
    it('serial hasher never overlaps', async () => {
        let current = 0;
        let max = 0;
    ...
    it('formatSeededCredentials is terminal text', () => {
    ...
    it('non-empty refuses without seeding or printing',
    async () => {
    ...
    it('seedPostgres seeds when mode is required',
    async () => {
        const db = memoryDbAdapter();
        const empty = fakeClient([{
            message_pairs: false,
    ...
    it('bootstrap seed prints credentials once',
    async () => {
        const db = memoryDbAdapter();
        const empty = fakeClient([{
            message_pairs: false,
    ...
    it('mock-data seed prints every human sign-in',
    async () => {
        const db = memoryDbAdapter();
        const empty = fakeClient([{
            message_pairs: false,
    ...
    if (POSTGRES_URL === undefined || POSTGRES_URL === '') {
        ...
        it('live empty bootstrap seeds then refuses',
        async () => {
