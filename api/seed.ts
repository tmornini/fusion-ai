...
export async function populateMockData(adapter: DbAdapter): Promise<void> {
  ...
  const ideas = [
    ...
    ]), effort_duration_estimate: '3-4 months', effort_team_size: '4-5 engineers', cost_estimate: '$120,000 - $150,000', cost_breakdown: 'Development: $80K, API costs: $20K/year, Training: $10K' },
