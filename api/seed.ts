...
export async function populateMockData(adapter: DbAdapter): Promise<void> {
  ...
  const users = [
    ...
    { id: '9', first_name: 'Lisa', last_name: 'Wang', email: 'lisa@acmecorp.com', role: 'viewer', department: 'Sales', status: 'active', availability: 70, performance_score: 80, projects_completed: 3, current_projects: 1, strengths: ['Sales Strategy', 'Client Relations'], team_dimensions: { driver: 80, analytical: 55, expressive: 85, amiable: 75 }, phone: '', bio: '', last_active: '2024-02-27T18:00:00.000000Z' },
    { id: '10', first_name: 'James', last_name: 'Miller', email: 'james@acmecorp.com', role: 'member', department: 'Engineering', status: 'deactivated', availability: 0, performance_score: 78, projects_completed: 6, current_projects: 0, strengths: ['Backend Development', 'Python'], team_dimensions: { driver: 55, analytical: 82, expressive: 40, amiable: 50 }, phone: '', bio: '', last_active: '2024-02-21T18:00:00.000000Z' },
  ...
  const ideas = [
    ...
    ]), effort_duration_estimate: '3-4 months', effort_team_size: '4-5 engineers', cost_estimate: '$120,000 - $150,000', cost_breakdown: 'Development: $80K, API costs: $20K/year, Training: $10K', success_metrics: '' },
    { id: '8', title: 'Mobile App Push Notification Revamp', score: 72, estimated_impact: 0, estimated_duration: 0, estimated_cost: 0, priority: 10, status: 'in-review', submitted_by_id: '7', edge_status: 'draft', problem_statement: '', proposed_solution: '', expected_outcome: '', category: 'Product', readiness: 'needs-info', waiting_days: 4, impact_label: 'Medium', effort_label: 'Low', description: '', submitted_at: '', risks: '[]', assumptions: '[]', alignments: '[]', effort_duration_estimate: '', effort_team_size: '', cost_estimate: '', cost_breakdown: '', success_metrics: '' },
    { id: '9', title: 'Sustainability Dashboard for Operations', score: 81, estimated_impact: 0, estimated_duration: 0, estimated_cost: 0, priority: 9, status: 'in-review', submitted_by_id: '5', edge_status: 'complete', problem_statement: '', proposed_solution: '', expected_outcome: '', category: 'Operations', readiness: 'ready', waiting_days: 6, impact_label: 'High', effort_label: 'High', description: '', submitted_at: '', risks: '[]', assumptions: '[]', alignments: '[]', effort_duration_estimate: '', effort_team_size: '', cost_estimate: '', cost_breakdown: '', success_metrics: '' },
    { id: '10', title: 'Employee Wellness Program Integration', score: 45, estimated_impact: 0, estimated_duration: 0, estimated_cost: 0, priority: 11, status: 'in-review', submitted_by_id: '8', edge_status: 'missing', problem_statement: '', proposed_solution: '', expected_outcome: '', category: 'HR', readiness: 'incomplete', waiting_days: 8, impact_label: 'Medium', effort_label: 'Medium', description: '', submitted_at: '', risks: '[]', assumptions: '[]', alignments: '[]', effort_duration_estimate: '', effort_team_size: '', cost_estimate: '', cost_breakdown: '', success_metrics: '' },
    { id: '11', title: 'Real-time Inventory Tracking System', score: 91, estimated_impact: 0, estimated_duration: 0, estimated_cost: 0, priority: 7, status: 'in-review', submitted_by_id: '9', edge_status: 'complete', problem_statement: '', proposed_solution: '', expected_outcome: '', category: 'Operations', readiness: 'ready', waiting_days: 5, impact_label: 'High', effort_label: 'Medium', description: '', submitted_at: '', risks: '[]', assumptions: '[]', alignments: '[]', effort_duration_estimate: '', effort_team_size: '', cost_estimate: '', cost_breakdown: '', success_metrics: '' },
  ];
  ...
  await Promise.all([
    ...
    adapter.account.put({
      plan: 'Business',
      plan_status: 'active',
      next_billing: '2025-01-15T00:00:00.000000Z',
      seats: 25,
      used_seats: 18,
      projects_limit: 50,
      projects_current: 12,
      ...
      last_activity: '2024-02-28T16:00:00.000000Z',
      active_users: 14,
    }),
  ]);
  ...
  // ── Projects ───────────────────────────────
  const projects = [
    { id: '1', title: 'AI-Powered Customer Segmentation', description: 'Implement machine learning model to automatically segment customers based on behavior, purchase history, and engagement patterns.', status: 'approved', progress: 72, start_date: '2024-01-15T00:00:00.000000Z', target_end_date: '2024-04-15T00:00:00.000000Z', lead_id: '1', estimated_duration: 432000, actual_duration: 306000, estimated_cost: 45000, actual_cost: 38000, estimated_impact: 85, actual_impact: 78, priority: 1, priority_score: 92, linked_idea_id: '1', business_context: JSON.stringify({ problem: "Current manual segmentation takes 2 weeks and is often outdated by the time it's complete. Marketing campaigns suffer from poor targeting.", expectedOutcome: 'Real-time customer segments that update automatically, enabling personalized marketing with 40% better conversion rates.', successMetrics: ['Reduce segmentation time from 2 weeks to real-time', 'Improve campaign conversion rates by 40%', 'Increase customer lifetime value by 25%'], constraints: ['Must integrate with existing CRM (Salesforce)', 'GDPR compliance required for EU customers', 'Budget capped at $50,000 for Phase 1'] }), timeline_label: '3-4 months', budget_label: '$45,000' },
    { id: '2', title: 'Automated Report Generation', description: '', status: 'approved', progress: 85, start_date: '', target_end_date: '', lead_id: '2', estimated_duration: 288000, actual_duration: 216000, estimated_cost: 32000, actual_cost: 28000, estimated_impact: 78, actual_impact: 82, priority: 2, priority_score: 87, linked_idea_id: '2', business_context: '{}', timeline_label: '', budget_label: '' },
    { id: '3', title: 'Predictive Maintenance System', description: '', status: 'under-review', progress: 22, start_date: '', target_end_date: '', lead_id: '5', estimated_duration: 720000, actual_duration: 162000, estimated_cost: 75000, actual_cost: 18000, estimated_impact: 90, actual_impact: 0, priority: 3, priority_score: 84, linked_idea_id: '3', business_context: '{}', timeline_label: '', budget_label: '' },
    { id: '4', title: 'Real-time Analytics Dashboard', description: '', status: 'approved', progress: 95, start_date: '', target_end_date: '', lead_id: '8', estimated_duration: 216000, actual_duration: 198000, estimated_cost: 28000, actual_cost: 26000, estimated_impact: 72, actual_impact: 70, priority: 4, priority_score: 81, linked_idea_id: '4', business_context: '{}', timeline_label: '', budget_label: '' },
    { id: '5', title: 'Smart Inventory Optimization', description: '', status: 'sent-back', progress: 15, start_date: '', target_end_date: '', lead_id: '9', estimated_duration: 360000, actual_duration: 108000, estimated_cost: 38000, actual_cost: 12000, estimated_impact: 68, actual_impact: 0, priority: 5, priority_score: 78, linked_idea_id: '5', business_context: '{}', timeline_label: '', budget_label: '' },
    { id: '6', title: 'Employee Training Assistant', description: '', status: 'under-review', progress: 18, start_date: '', target_end_date: '', lead_id: '3', estimated_duration: 324000, actual_duration: 72000, estimated_cost: 35000, actual_cost: 8000, estimated_impact: 65, actual_impact: 0, priority: 6, priority_score: 74, linked_idea_id: '6', business_context: '{}', timeline_label: '', budget_label: '' },
  ];
  ...
  const edges = [
    ...
    { id: '2', idea_id: '2', status: 'complete', confidence: 'medium', owner_id: '2', impact_short_term: '', impact_mid_term: '', impact_long_term: '', updated_at: '2024-02-25T10:00:00.000000Z' },
    { id: '3', idea_id: '3', status: 'draft', confidence: 'low', owner_id: '5', impact_short_term: '', impact_mid_term: '', impact_long_term: '', updated_at: '2024-02-20T09:00:00.000000Z' },
    { id: '4', idea_id: '4', status: 'complete', confidence: 'high', owner_id: '8', impact_short_term: '', impact_mid_term: '', impact_long_term: '', updated_at: '2024-02-18T11:00:00.000000Z' },
    { id: '5', idea_id: '5', status: 'missing', confidence: null, owner_id: '', impact_short_term: '', impact_mid_term: '', impact_long_term: '', updated_at: '' },
    { id: '6', idea_id: '7', status: 'complete', confidence: 'high', owner_id: '1', impact_short_term: 'Handle 60% of tier-1 inquiries automatically. Reduce agent workload significantly.', impact_mid_term: '40% reduction in support costs. Improved 24/7 availability for customers.', impact_long_term: 'Full self-service capability for common issues. Agents focus on complex cases only.', updated_at: '2024-02-28T14:30:00.000000Z' },
  ];

  const activities = [
    { id: '1', type: 'idea_scored', actor_id: '1', action: 'scored', target: 'AI-Powered Customer Support Bot', timestamp: '2024-02-28T17:50:00.000000Z', score: 87, status: null, comment: null },
    { id: '2', type: 'task_completed', actor_id: '7', action: 'completed task', target: 'Design system audit', timestamp: '2024-02-28T17:35:00.000000Z', score: null, status: null, comment: null },
    { id: '3', type: 'idea_created', actor_id: '5', action: 'submitted new idea', target: 'Mobile App Redesign', timestamp: '2024-02-28T17:00:00.000000Z', score: null, status: null, comment: null },
    { id: '4', type: 'comment_added', actor_id: '4', action: 'commented on', target: 'Q1 Analytics Dashboard', timestamp: '2024-02-28T16:00:00.000000Z', score: null, status: null, comment: 'Great progress on the charts!' },
    { id: '5', type: 'user_joined', actor_id: '6', action: 'joined the team', target: 'Product Innovation', timestamp: '2024-02-28T15:00:00.000000Z', score: null, status: null, comment: null },
    { id: '6', type: 'status_changed', actor_id: '9', action: 'changed status of', target: 'Customer Feedback Portal', timestamp: '2024-02-28T14:00:00.000000Z', score: null, status: 'In Progress', comment: null },
    { id: '7', type: 'idea_converted', actor_id: '10', action: 'converted idea to project', target: 'Automated Testing Framework', timestamp: '2024-02-28T13:00:00.000000Z', score: null, status: null, comment: null },
    { id: '8', type: 'project_created', actor_id: '1', action: 'created new project', target: 'Performance Optimization Initiative', timestamp: '2024-02-28T12:00:00.000000Z', score: null, status: null, comment: null },
    { id: '9', type: 'task_completed', actor_id: '5', action: 'completed task', target: 'API documentation update', timestamp: '2024-02-27T18:00:00.000000Z', score: null, status: null, comment: null },
    { id: '10', type: 'idea_scored', actor_id: '7', action: 'scored', target: 'Data Pipeline Modernization', timestamp: '2024-02-27T15:00:00.000000Z', score: 92, status: null, comment: null },
  ];
  ...
  const crunchColumns = [
    ...
    { id: '2', original_name: 'TXN_DT', friendly_name: '', data_type: 'date', description: '', sample_values: JSON.stringify(['2024-01-15T00:00:00.000000Z', '2024-01-16T00:00:00.000000Z', '2024-01-17T00:00:00.000000Z']), is_acronym: 1, acronym_expansion: '' },
  ...
  const milestones = [
    { id: 'm1', project_id: '1', title: 'Data Pipeline Setup', status: 'completed', date: '2024-01-30T00:00:00.000000Z', sort_order: 1 },
    { id: 'm2', project_id: '1', title: 'Model Training Complete', status: 'completed', date: '2024-02-15T00:00:00.000000Z', sort_order: 2 },
    { id: 'm3', project_id: '1', title: 'Integration Testing', status: 'in_progress', date: '2024-03-01T00:00:00.000000Z', sort_order: 3 },
    { id: 'm4', project_id: '1', title: 'User Acceptance Testing', status: 'pending', date: '2024-03-20T00:00:00.000000Z', sort_order: 4 },
    { id: 'm5', project_id: '1', title: 'Production Deployment', status: 'pending', date: '2024-04-01T00:00:00.000000Z', sort_order: 5 },
  ];

  const tasks = [
    { id: 'task-1', project_id: '1', name: 'Set up data pipeline', priority: 'High', description: 'Configure ETL pipeline for customer data ingestion', skills: JSON.stringify(['Python', 'Apache Airflow', 'SQL']), duration: 86400, assigned_to_id: '2' },
    { id: 'task-2', project_id: '1', name: 'Train ML model', priority: 'High', description: 'Develop and train clustering model using customer behavior data', skills: JSON.stringify(['Machine Learning', 'Python', 'scikit-learn']), duration: 144000, assigned_to_id: '' },
    { id: 'task-3', project_id: '1', name: 'Design dashboard UI', priority: 'Medium', description: 'Create visual interface for segment exploration and management', skills: JSON.stringify(['React', 'D3.js', 'CSS']), duration: 115200, assigned_to_id: '' },
    { id: 'task-4', project_id: '1', name: 'Build API endpoints', priority: 'Medium', description: 'RESTful API for segment data access and management', skills: JSON.stringify(['Node.js', 'REST API', 'PostgreSQL']), duration: 72000, assigned_to_id: '' },
    { id: 'task-5', project_id: '1', name: 'Create documentation', priority: 'Low', description: 'Technical documentation and user guides for the segmentation system', skills: JSON.stringify(['Technical Writing', 'Markdown']), duration: 43200, assigned_to_id: '' },
  ];

  const discussions = [
    { id: 'd1', project_id: '1', author_id: '1', date: '2024-02-28T14:00:00.000000Z', message: 'Great progress on the integration testing. We should be ready for UAT next week.' },
    { id: 'd2', project_id: '1', author_id: '2', date: '2024-02-25T10:30:00.000000Z', message: 'Segmentation accuracy is now at 94%. Exceeding our initial target of 90%.' },
    { id: 'd3', project_id: '1', author_id: '4', date: '2024-02-20T16:00:00.000000Z', message: 'API endpoints are ready for frontend integration.' },
  ];

  const versions = [
    { id: 'v1', project_id: '1', version: 'v1.2', date: '2024-02-28T09:00:00.000000Z', changes: 'Added real-time segmentation capability', author_id: '2' },
    { id: 'v2', project_id: '1', version: 'v1.1', date: '2024-02-15T09:00:00.000000Z', changes: 'Improved model accuracy by 12%', author_id: '3' },
    { id: 'v3', project_id: '1', version: 'v1.0', date: '2024-01-30T09:00:00.000000Z', changes: 'Initial model deployment', author_id: '1' },
  ];

  const clarifications = [
    { id: 'c1', project_id: '1', question: 'What data sources are currently available for customer behavior tracking? We need to understand the data pipeline before designing the ML model.', asked_by_id: '2', asked_at: '2024-02-20T10:00:00.000000Z', status: 'answered', answer: 'We have event tracking via Segment, transaction data in our data warehouse (Snowflake), and email engagement metrics from Mailchimp. All can be accessed via APIs.', answered_by_id: '1', answered_at: '2024-02-21T14:00:00.000000Z' },
    { id: 'c2', project_id: '1', question: 'Are there any existing segment definitions we should match, or are we free to discover optimal segments through clustering?', asked_by_id: '3', asked_at: '2024-02-22T09:30:00.000000Z', status: 'answered', answer: "Marketing has 5 legacy segments they use today (High Value, Growth, At-Risk, New, Dormant). We'd like to preserve compatibility but welcome additional discovered segments.", answered_by_id: '1', answered_at: '2024-02-22T16:00:00.000000Z' },
    { id: 'c3', project_id: '1', question: "What's the expected latency requirement for segment updates? Real-time vs batch processing has significant architecture implications.", asked_by_id: '4', asked_at: '2024-02-25T11:00:00.000000Z', status: 'pending', answer: null, answered_by_id: null, answered_at: null },
  ];
