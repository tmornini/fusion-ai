...
export async function seedData(adapter: DbAdapter): Promise<void> {
  ...
  const ideas = [
    ...
    { id: '2', title: 'Automated Report Generation', score: 87, estimated_impact: 78, estimated_time: 80, estimated_cost: 32000, priority: 2, status: 'approved', submitted_by_id: '2', edge_status: 'complete', problem_statement: '', proposed_solution: '', expected_outcome: '', category: '', readiness: '', waiting_days: 0, impact_label: '', effort_label: '', description: '', submitted_at: '', risks: '[]', assumptions: '[]', alignments: '[]', effort_time_estimate: '', effort_team_size: '', cost_estimate: '', cost_breakdown: '' },
    { id: '3', title: 'Predictive Maintenance System', score: 84, estimated_impact: 90, estimated_time: 200, estimated_cost: 75000, priority: 3, status: 'scored', submitted_by_id: '5', edge_status: 'draft', problem_statement: '', proposed_solution: '', expected_outcome: '', category: '', readiness: '', waiting_days: 0, impact_label: '', effort_label: '', description: '', submitted_at: '', risks: '[]', assumptions: '[]', alignments: '[]', effort_time_estimate: '', effort_team_size: '', cost_estimate: '', cost_breakdown: '' },
    { id: '4', title: 'Real-time Analytics Dashboard', score: 81, estimated_impact: 72, estimated_time: 60, estimated_cost: 28000, priority: 4, status: 'pending_review', submitted_by_id: '8', edge_status: 'complete', problem_statement: '', proposed_solution: '', expected_outcome: '', category: '', readiness: '', waiting_days: 0, impact_label: '', effort_label: '', description: '', submitted_at: '', risks: '[]', assumptions: '[]', alignments: '[]', effort_time_estimate: '', effort_team_size: '', cost_estimate: '', cost_breakdown: '' },
    { id: '5', title: 'Smart Inventory Optimization', score: 78, estimated_impact: 68, estimated_time: 100, estimated_cost: 38000, priority: 5, status: 'draft', submitted_by_id: '9', edge_status: 'incomplete', problem_statement: '', proposed_solution: '', expected_outcome: '', category: '', readiness: '', waiting_days: 0, impact_label: '', effort_label: '', description: '', submitted_at: '', risks: '[]', assumptions: '[]', alignments: '[]', effort_time_estimate: '', effort_team_size: '', cost_estimate: '', cost_breakdown: '' },
    ...
    { id: '8', title: 'Mobile App Push Notification Revamp', score: 72, estimated_impact: 0, estimated_time: 0, estimated_cost: 0, priority: 0, status: 'pending_review', submitted_by_id: '7', edge_status: 'draft', problem_statement: '', proposed_solution: '', expected_outcome: '', category: 'Product', readiness: 'needs-info', waiting_days: 4, impact_label: 'Medium', effort_label: 'Low', description: '', submitted_at: '', risks: '[]', assumptions: '[]', alignments: '[]', effort_time_estimate: '', effort_team_size: '', cost_estimate: '', cost_breakdown: '' },
    { id: '9', title: 'Sustainability Dashboard for Operations', score: 81, estimated_impact: 0, estimated_time: 0, estimated_cost: 0, priority: 0, status: 'pending_review', submitted_by_id: '5', edge_status: 'complete', problem_statement: '', proposed_solution: '', expected_outcome: '', category: 'Operations', readiness: 'ready', waiting_days: 6, impact_label: 'High', effort_label: 'High', description: '', submitted_at: '', risks: '[]', assumptions: '[]', alignments: '[]', effort_time_estimate: '', effort_team_size: '', cost_estimate: '', cost_breakdown: '' },
    { id: '10', title: 'Employee Wellness Program Integration', score: 45, estimated_impact: 0, estimated_time: 0, estimated_cost: 0, priority: 0, status: 'pending_review', submitted_by_id: '8', edge_status: 'missing', problem_statement: '', proposed_solution: '', expected_outcome: '', category: 'HR', readiness: 'incomplete', waiting_days: 8, impact_label: 'Medium', effort_label: 'Medium', description: '', submitted_at: '', risks: '[]', assumptions: '[]', alignments: '[]', effort_time_estimate: '', effort_team_size: '', cost_estimate: '', cost_breakdown: '' },
    { id: '11', title: 'Real-time Inventory Tracking System', score: 91, estimated_impact: 0, estimated_time: 0, estimated_cost: 0, priority: 0, status: 'pending_review', submitted_by_id: '9', edge_status: 'complete', problem_statement: '', proposed_solution: '', expected_outcome: '', category: 'Operations', readiness: 'ready', waiting_days: 5, impact_label: 'High', effort_label: 'Medium', description: '', submitted_at: '', risks: '[]', assumptions: '[]', alignments: '[]', effort_time_estimate: '', effort_team_size: '', cost_estimate: '', cost_breakdown: '' },
  ];
