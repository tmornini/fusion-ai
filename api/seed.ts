...
export async function populateMockData(adapter: DbAdapter): Promise<void> {
  ...
  const ideas = [
    ...
    { id: '8', title: 'Mobile App Push Notification Revamp', score: 72, estimated_impact: 0, estimated_duration: 0, estimated_cost: 0, priority: 10, status: 'pending_review', submitted_by_id: '7', edge_status: 'draft', problem_statement: '', proposed_solution: '', expected_outcome: '', category: 'Product', readiness: 'needs-info', waiting_days: 4, impact_label: 'Medium', effort_label: 'Low', description: '', submitted_at: '', risks: '[]', assumptions: '[]', alignments: '[]', effort_duration_estimate: '', effort_team_size: '', cost_estimate: '', cost_breakdown: '' },
    { id: '9', title: 'Sustainability Dashboard for Operations', score: 81, estimated_impact: 0, estimated_duration: 0, estimated_cost: 0, priority: 9, status: 'pending_review', submitted_by_id: '5', edge_status: 'complete', problem_statement: '', proposed_solution: '', expected_outcome: '', category: 'Operations', readiness: 'ready', waiting_days: 6, impact_label: 'High', effort_label: 'High', description: '', submitted_at: '', risks: '[]', assumptions: '[]', alignments: '[]', effort_duration_estimate: '', effort_team_size: '', cost_estimate: '', cost_breakdown: '' },
    { id: '10', title: 'Employee Wellness Program Integration', score: 45, estimated_impact: 0, estimated_duration: 0, estimated_cost: 0, priority: 11, status: 'pending_review', submitted_by_id: '8', edge_status: 'missing', problem_statement: '', proposed_solution: '', expected_outcome: '', category: 'HR', readiness: 'incomplete', waiting_days: 8, impact_label: 'Medium', effort_label: 'Medium', description: '', submitted_at: '', risks: '[]', assumptions: '[]', alignments: '[]', effort_duration_estimate: '', effort_team_size: '', cost_estimate: '', cost_breakdown: '' },
  ...
  const projects = [
    ...
    { id: '5', title: 'Smart Inventory Optimization', description: '', status: 'sent_back', progress: 15, start_date: '', target_end_date: '', lead_id: '9', estimated_duration: 360000, actual_duration: 108000, estimated_cost: 38000, actual_cost: 12000, estimated_impact: 68, actual_impact: 0, priority: 5, priority_score: 78, linked_idea_id: '5', business_context: '{}', timeline_label: '', budget_label: '' },
    { id: '6', title: 'Employee Training Assistant', description: '', status: 'under_review', progress: 18, start_date: '', target_end_date: '', lead_id: '3', estimated_duration: 324000, actual_duration: 72000, estimated_cost: 35000, actual_cost: 8000, estimated_impact: 65, actual_impact: 0, priority: 6, priority_score: 74, linked_idea_id: '6', business_context: '{}', timeline_label: '', budget_label: '' },
  ];
